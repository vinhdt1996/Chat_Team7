...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void AnhXa() {
        mDisplayImage = (CircleImageView) findViewById(R.id.imgSettings);
        mName = (TextView) findViewById(R.id.txtNameSettings);
        mStatus = (TextView) findViewById(R.id.txtStatusSettings);
        mStatusBtn = (Button) findViewById(R.id.btnChangeStatusSettings);
        mImageBtn = (Button) findViewById(R.id.btnChangeImageSettings);
    }
    @Override
